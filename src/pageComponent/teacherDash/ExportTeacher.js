...
const ExportTeacher =()=>{
    ...
    const handleFileChange = (event) => {
      ...
      const importFunc = async () =>{
        try{
        const response = await axios.post(`${BASE_URL}/teacher/export_teacher_excel/5`, 
        {
      ...
      <Fragment>
        <Grid container className={styles.importTeacherCntr}>
            <Grid item xs={12} md={12} className={styles.importTeacherCntr1}>
               <ButtonGlobal onClick={handleDownloadClick} className={styles.dowCsvBtn} size="small" bgColor="green" width="auto" title="Download CSV" />
            </Grid>
        ...
        <div className="file-upload-container">
            ...
            <ButtonGlobal size="small" bgColor="green" width="auto" onClick={handleFileUpload} title="Upload File"></ButtonGlobal>
            </div>
