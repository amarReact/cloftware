...
const AddVisitor =({setIsAdd, yearId})=>{

  const formList = {
    name: '',
    purpose: '',
    phone: '',
    person_to_be_visited: '',
  }
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
         visitorPostFunc()
        toast.success(formData, {autoClose: 2000, position: "top-center"});
    } else {
                ...
                <form onSubmit={handleSubmit}>
                    <ol className={styles.threeparts}>
                      ...
                      <li className={styles.fullVideo}>
                        ...
                        <li className={styles.fullLi}><ButtonGlobal bgColor="green" title="Save" size="medium" radius="medium" width="auto" />
